			...
			<!-- BEGIN TOP NAVIGATION -->
				...
				<nav class="navbar-side" role="navigation">							
					<div class="navbar-collapse sidebar-collapse collapse">
						...
						<div class="sidebar-alerts" id="printItems1">							
												...
												<div class="portlet-body">
													<div class="row">
														...
														<div class="col-sm-3">
															...
															<!-- Buttons -->
															<button class="btn btn-sm btn-primary" id="print"><i class="fa fa-file-pdf-o"></i>Generate PDF</button>
														</div>
